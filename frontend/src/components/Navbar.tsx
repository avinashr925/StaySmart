...
import { Sun, Moon, Search, User, LogOut, Compass, LayoutDashboard, Heart, Calendar, MessageSquare } from "lucide-react";
            ...
            <div className="relative">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 p-1.5 border border-zinc-200 dark:border-zinc-800 rounded-full hover:shadow-sm focus:outline-none"
                >
